            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    ...
                    <div v-for="vid in video" :key="vid">
                        <iframe :src="vid" frameborder="0" height=200 allowfullscreen></iframe>
                    </div>
                    <ul class="stats">
                        <li>
...
<tr v-for="record in level.records" class="record">
    ...
    <td class="user">
    <div v-for="(user, index) in record.user" :key="index">
        <a :href="record.link[index]" target="_blank" class="type-label-lg">
            {{ user }}
        </a>
    </div>
</td>
...
<img v-if="record.mobile" :src="'/assets/phone-landscape' + (store.dark ? '-dark' : '') + '.svg'" alt="Mobile">
    ...
    async mounted() {
        ...
        this.editors = await fetchLeaderboard();
